        ...
        public async Task<IEnumerable<GioHangChiTiet>> GetCartItem(string username)
        {
            ...
            try
            {
                ...
                cartItem = (
                           ...
                           join y in await _context.GioHangChiTiets.ToListAsync() on x.NguoiDungId equals y.GioHangId
                ...
                return cartItem.Where(x => x.GioHangId.ToString() == user.Id);// Trả về list với điểu kiện 
            }
            catch (Exception)
            {
