...
namespace Shop_Api.Migrations
{
    ...
    [Migration("20240416080011_data-ctsp")]
    partial class datactsp
    {
            ...
            modelBuilder.Entity("Shop_Models.Entities.ChiTietSanPham", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("eaef531c-d1d2-49b5-af9d-8be4a0efd30d"),
                            GiaBan = 589380.0,
                            GiaNhap = 498877.0,
                            GiaThucTe = 190083.0,
                            MaSanPham = "SP2",
                        ...
                        new
                        {
                            Id = new Guid("8c737d04-31ec-404b-b622-dc12c7d93cb7"),
                            GiaBan = 502463.0,
                            GiaNhap = 131780.0,
                            GiaThucTe = 677858.0,
                            MaSanPham = "SP5",
                        ...
                        new
                        {
                            Id = new Guid("dff773cc-53e2-40f1-b7e2-f10ac8e4f24a"),
                            GiaBan = 403781.0,
                            GiaNhap = 724415.0,
                            GiaThucTe = 848790.0,
                            MaSanPham = "SP2",
                        ...
                        new
                        {
                            Id = new Guid("dd07d0d6-0865-4a0b-83ca-fb0ede30423a"),
                            GiaBan = 129957.0,
                            GiaNhap = 504809.0,
                            GiaThucTe = 432475.0,
                            MaSanPham = "SP2",
                        ...
                        new
                        {
                            Id = new Guid("0d654694-bd67-4f83-a657-5b60340b59ca"),
                            GiaBan = 694035.0,
                            GiaNhap = 696635.0,
                            GiaThucTe = 830321.0,
                            MaSanPham = "SP2",
